...
{
    public partial class Fguard : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string str = "DELETE FROM Guardian WHERE g_Id =@id";
            try
            {
                con.Open();
                OleDbCommand comm;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0; Data Source=" + path);
            {
                try
                {
                    string str = @"INSERT INTO Guardian (G_id, G_name, G_Surname, G_nr, G_adress)" +
        ...
        void addDataToGrid(string str = @"SELECT * FROM Guardian ORDER BY G_id")
        {
            OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0; Data Source=" + path);
            {
        ...
        private void Fguard_Load(object sender, EventArgs e)
        {
            addDataToGrid();
        }
    }
